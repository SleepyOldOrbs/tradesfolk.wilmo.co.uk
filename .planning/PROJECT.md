...
<!-- Current milestone: v1.1.0 — Agent Pool Expansion -->

- [x] 8 new specialist agents (platform specialists + AI/ML depth)
- [x] 5 new team templates for mobile, AI, and IoT scenarios
- [x] browse-pool and assemble-team skills updated with 20-agent roster
- [x] CLAUDE.md roster table updated for 20 agents
- [x] README.md and CHANGELOG.md updated for v1.1.0
- [x] Context budget verified with 20 agents loaded
...
**Target features:**
- 4 platform specialist agents (react-native-developer, ios-developer, android-developer, embedded-engineer)
- 4 AI/ML depth agents (llm-application-developer, prompt-engineer, mlops-engineer, computer-vision-engineer)
- 5 new team templates (Mobile App, Native iOS+Android, AI Application, ML Pipeline, IoT System)
- Updated skills, documentation, and context budget verification

---
*Last updated: 2026-02-20 after milestone v1.1.0 started*
